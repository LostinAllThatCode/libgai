...
#define GAI_OPENGL_FUNC_DEF(x,y)  static PFNGL##x##PROC __gl##y;
GAI_OPENGL_EXTENSIONS_CORE

#ifdef GAI_OPENGL_EXTENSIONS_USE_ARB
#   undef  GAI_OPENGL_FUNC_DEF
#   define GAI_OPENGL_FUNC_DEF(x,y)  static PFNGL##x##ARBPROC __gl##y##ARB;
#endif
...
gaiOpenGLInitialzeFunctions()
{
    ...
    #define GAI_OPENGL_FUNC_DEF(x,y) __gl##y = (PFNGL##x##PROC) wglGetProcAddress("gl" #y);
    GAI_OPENGL_EXTENSIONS_CORE
        
    #ifdef GAI_OPENGL_EXTENSIONS_USE_ARB
    #   undef  GAI_OPENGL_FUNC_DEF
    #   define GAI_OPENGL_FUNC_DEF(x,y) __gl##y##ARB = (PFNGL##x##ARBPROC) wglGetProcAddress("gl" #y "ARB");
    #endif
